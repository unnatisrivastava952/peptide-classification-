...
with st.sidebar:
    st.link_button("Help Page", "https://github.com/yourusername/yourrepo/blob/main/HELP.md")
    st.link_button("About / Manual", "https://github.com/yourusername/yourrepo/blob/main/ABOUT.md")
